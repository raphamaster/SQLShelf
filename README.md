...
<p align="center">
  <a href="https://github.com/raphamaster/SQLShelf/releases/latest">
    <img src="https://img.shields.io/badge/release-v1.0.10-0ADE99?style=flat-square" alt="Latest release"/>
  </a>
...
|----------|-----------|----------------------|
| **Windows 10/11 x64** | [SQLShelf-1.0.10-windows-x64-setup.exe](https://github.com/raphamaster/SQLShelf/releases/latest) | [SQLShelf-1.0.10-windows-x64-portable.zip](https://github.com/raphamaster/SQLShelf/releases/latest) |
| **Linux x86_64** | [SQLShelf-1.0.10-linux-x86_64.AppImage](https://github.com/raphamaster/SQLShelf/releases/latest) | [SQLShelf-1.0.10-linux-x86_64-portable.zip](https://github.com/raphamaster/SQLShelf/releases/latest) |
