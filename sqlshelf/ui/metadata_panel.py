...
class MetadataPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._title_label.setStyleSheet(f"font-weight: bold; font-size: 13px; color: {TEXT_PRIMARY};")
    ...
    def _rebuild_links(self) -> None:
        prefix_style = f'color:{LINK_PREFIX};'
        if self._tables:
    ...
    def _make_links(self, items: list[str], prefix: str) -> str:
        return " ".join(
            f'<a href="{prefix}{t}" style="color:{LINK}; '
